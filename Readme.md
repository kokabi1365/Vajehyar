...
فرصت‌هایِ متنوعی برای مشارکت وجود داره که چندتاش از قرار زیر هست. بعضی از این موارد به خاطرِ نقصِ دانشِ فنیِ بوده ؛ مثلاً پیاده‌سازیِ قابلیتِ Data Virtualization و بعضی‌ها رو هنوز فرصت نکردم بهشون رسیدگی کنم. در هر دو صورت بد نیست که این مسائل سریع‌تر حل بشه تا روندِ توسعه شتاب پیدا کنه.
